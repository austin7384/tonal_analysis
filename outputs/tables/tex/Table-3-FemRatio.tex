\begin{sidewaystable}[p]
    ...
    \begin{threeparttable}
        ...
        \begin{tabular}{p{3cm}S@{}S@{}S@{}S@{}S@{}S@{}S@{}S@{}S@{}}
            ...
            \mrow{3cm}{LLM Readability}   &        0.36***&        0.35***&        0.35***&        0.40***&        0.32***&        0.39***&        0.31***&        0.38***&        0.27***\\
        ...
        \begin{tablenotes}
            \tiny
            \item \textit{Notes}. Figures represent coefficients on female ratio from 54 separate OLS regressions of readability scores on the ratio of female authors (papers with fewer than 50 percent female authors are classified as male, see the text). (6)--(9) are estimated on the sample of papers published on or after 1990 with a primary \textit{JEL} code; (9) includes 563 articles from \textit{AER P\& P} (see~the paper). Quality controls denoted by \(\text{\ding{51}}^1\) include citation count (asinh), \(\text{max. }T\) fixed effects (author prominence) and \(\text{max. }t\) (author seniority). Standard errors clustered on editor in parentheses. ***, ** and * statistically significant at 1\%, 5\% and 10\%, respectively.
        \end{tablenotes}
    \end{threeparttable}
