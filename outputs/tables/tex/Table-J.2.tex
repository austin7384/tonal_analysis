\begin{ThreePartTable}
    \begin{TableNotes}
        \tiny\item \textit{Notes}. Table lists the names of matched pairs from~the quantification section. In each panel, female members are listed first; male members second. Matches were generated in Stata using \texttt{psmatch2}~\citep{Leuven2003}. See~the matching estimation section for details on the matching process.
    \end{TableNotes}
