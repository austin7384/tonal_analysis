    ...
    \begin{threeparttable}
        ...
        \begin{tabular}{p{4cm}S@{}S@{}S@{}}
            ...
            \mrow{4cm}{Lagged score (\(\beta_0\))}&        0.05** &        0.04*  &        0.04*  \\
                                          &      (0.02)   &      (0.02)   &      (0.02)   \\
            \midruleNo. observations      &       9,181   &       9,181   &       9,181   \\
            \mcol{\textit{Tests of instrument validity}} \\\quad Hansen test (\(p\)-value)&       0.841   &       0.735   &       0.734   \\
            \quad Sargan test (\(p\)-value)&       0.156   &       0.213   &       0.112   \\
            \mcol{\textit{\(z\)-test for no serial correlation}} \\\quad Order 1&     -12.478   &     -13.245   &     -16.851   \\
            \quad Order 2                 &       0.084   &       0.586   &       0.464   \\
            \midruleEditor effects        &           {\ding{51}}   &           {\ding{51}}   &           {\ding{51}}   \\
