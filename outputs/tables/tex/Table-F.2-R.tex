\begin{table}
    ...
    \begin{threeparttable}
        ...
        \begin{tabular}{p{4cm}S@{}S@{}S@{}}
            ...
            \multicolumn{4}{l}{\textit{Tests of instrument validity}} \\\quad Hansen test (\(p\)-value)&       0.841   &       0.735   &       0.734   \\
            \quad Sargan test (\(p\)-value)&       0.156   &       0.213   &       0.112   \\
            \multicolumn{4}{l}{\textit{\(z\)-test for no serial correlation}} \\\quad Order 1&     -12.478   &     -13.245   &     -16.851   \\
