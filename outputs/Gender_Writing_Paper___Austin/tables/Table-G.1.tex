\begin{table}
    ...
    \begin{threeparttable}
        ...
        \begin{tablenotes}
            \tiny
            \item \textit{Notes}. Coefficients from OLS regression of equation~(2). Coefficients in the first three rows correspond to the estimates presented in the first panel of \autoref{table6_FemRatio}. Standard errors clustered on editor (in parentheses). ***, ** and * statistically significant at 1\%, 5\% and 10\%, respectively.
        \end{tablenotes}
    \end{threeparttable}
\end{table}