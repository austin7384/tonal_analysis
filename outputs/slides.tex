...
\begin{frame}{Female-majority teams score higher on clarity; tonal differences are negligible}
    ...
    \end{center}
    \begin{center}
        {\small\color{WarmGray} Values standardized (mean 0, SD 1) across the full sample. Null: assertiveness, hedging, emotional valence --- no difference between male- and female-majority teams.}
    \end{center}
\end{frame}
...
% ---------------------------------------------------------------------------
% Backup E: Figure 3 — joint readability panels (draft vs. final by t)
% ---------------------------------------------------------------------------
\begin{frame}{Appendix: Readability of author's \textit{t}th paper (draft and final)}
    \begin{columns}[T, onlytextwidth]
        \begin{column}{0.49\textwidth}
            \centering
            \adjustbox{max width=\textwidth, max height=0.68\textheight}{%
                \includegraphics{Figure-6.pdf}%
            }\\[0.05cm]
            {\small\color{WarmGray} (a) Flesch Readability}
        \end{column}
        \begin{column}{0.02\textwidth}\end{column}
        \begin{column}{0.49\textwidth}
            \centering
            \adjustbox{max width=\textwidth, max height=0.68\textheight}{%
                \includegraphics{Figure-6-llm.pdf}%
            }\\[0.05cm]
            {\small\color{WarmGray} (b) LLM Readability}
        \end{column}
    \end{columns}
    \vspace{0.1cm}
    \begin{center}
        {\small\color{WarmGray}
        Flesch gap shifts from peer review to draft quality as $t$ grows (preemptive adaptation). LLM gap is flat — peer review improves both genders equally at every $t$.}
    \end{center}
\end{frame}
