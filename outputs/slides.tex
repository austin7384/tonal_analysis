...
\begin{frame}{9,117 abstracts from four top economics journals, 1950--2015}
    ...
    \begin{itemize}\setlength\itemsep{0.28cm}
        \item Source: Hengel (2022) replication dataset --- 4 journals, 1950--2015; analysis on abstracts only
        ...
        \item Five authorship measures: female ratio, majority female, any female, 100\% female, solo female, senior female
    \end{itemize}
    }
    \vfill
\end{frame}
