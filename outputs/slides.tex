...
% 11. Robustness
% ---------------------------------------------------------------------------
\begin{frame}{The clarity differential is robust across six alternative authorship specifications}
    \vfill
    \begin{center}
    {\small
...
% ---------------------------------------------------------------------------
\begin{frame}{Backup: Tonal criteria — controlled regressions (G1--G2)}
    \vfill
    \begin{center}
    {\small
    \begin{tabular}{lcc}
...
% ---------------------------------------------------------------------------
\begin{frame}{Backup: Remaining criteria — controlled regressions (G3--G5)}
    \vfill
    \begin{center}
    {\small
    \begin{tabular}{lcc}
...
% ---------------------------------------------------------------------------
\begin{frame}{Backup: Tonal criteria — robustness across authorship specifications (G1--G2)}
    \vfill
    \begin{center}
    {\small
    \begin{tabular}{lcccccc}
...
% ---------------------------------------------------------------------------
\begin{frame}{Backup: Remaining criteria — robustness across authorship specifications (G3--G5)}
    \vfill
    \begin{center}
    {\small
    \begin{tabular}{lcccccc}
