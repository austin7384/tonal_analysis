...
\begin{frame}{Female-majority teams score higher on clarity; tonal differences are negligible}
    \begin{center}
        \adjustbox{max width=0.88\textwidth, max height=0.62\textheight}{%
            \includegraphics{diff_means_plot.pdf}%
        }
    \end{center}
    \begin{center}
        {\small\color{WarmGray}
        Papers classified female if $\geq\!50\%$ of authors are female. All criteria standardized. Jargon sign reversed.}
    \end{center}
\end{frame}
