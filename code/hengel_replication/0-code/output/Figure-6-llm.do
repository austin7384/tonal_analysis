********************************************************************************
****** Figure 6 LLM: LLM readability of authors' tth paper (draft and final) **
********************************************************************************
use `nber', clear
...
eststo nber: regress nber_llm_readability_score c.FemRatio##c.`tBin' Maxt MaxT asinhCiteCount N i.NativeEnglish i.Year##i.Journal i.Editor [aweight=AuthorWeight]
eststo reg:  regress _llm_readability_score     c.FemRatio##c.`tBin' Maxt MaxT asinhCiteCount N i.NativeEnglish i.Year##i.Journal i.Editor [aweight=AuthorWeight]
...
graph twoway ///
  ...
  title("LLM Readability", size(medsmall) color(gray)) ///
...
graph export "~/tonal_analysis/outputs/figures/Figure-6-llm.pdf", replace fontface("Avenir-Light") as(pdf)
********************************************************************************
