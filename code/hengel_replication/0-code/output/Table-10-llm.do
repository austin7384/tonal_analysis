********************************************************************************
****** Table 10 LLM: LLM readability of authors' tth paper (draft and final) **
********************************************************************************
use `nber', clear
...
estout est_* using "~/tonal_analysis/outputs/tables/tex/Table-10-llm.tex", style(publishing-female_latex) ///
...
create_latex using "`r(fn)'", tablename("table9llm")
estimates clear
********************************************************************************
