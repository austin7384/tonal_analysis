********************************************************************************
****** Table 10 LLM G3: LLM G3 composite score of authors' tth paper (draft and final) **
********************************************************************************
use `nber', clear
...
eststo nber: regress nber_llm_g3_score c.FemRatio##c.`tBin' Maxt MaxT asinhCiteCount N i.NativeEnglish i.Year##i.Journal i.Editor [aweight=AuthorWeight]
eststo reg:  regress _llm_g3_score     c.FemRatio##c.`tBin' Maxt MaxT asinhCiteCount N i.NativeEnglish i.Year##i.Journal i.Editor [aweight=AuthorWeight]
...
estout est_* using "~/tonal_analysis/outputs/tables/tex/Table-10-llm-g3.tex", style(publishing-female_latex) ///
...
create_latex using "`r(fn)'", tablename("table9llmg3")
estimates clear
********************************************************************************
