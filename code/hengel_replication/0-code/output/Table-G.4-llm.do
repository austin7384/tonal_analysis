********************************************************************************
***** Table G.4 LLM: Impact of double-blind review after the internet, LLM ****
********************************************************************************
* Semi-blind review.
use `nber_fe', clear
tempname B S
...
* Create LaTeX table.
estout semiblind_* using "~/tonal_analysis/outputs/tables/tex/Table-G.4-llm.tex", style(publishing-female_latex) ///
  ...
  varlabels(1.SemiBlind#c.FemRatio "Blind\(\times\)fem. ratio") ///
	prefoot("\midrule") ///
	eqlabels(none)
create_latex using "`r(fn)'", tablename("table7_semiblindllm")
********************************************************************************
