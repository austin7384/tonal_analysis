...
label define Journal 1 "AER" 2 "ECA" 3 "JPE" 4 "QJE" 5 "P&P" 6 "RES"
encode_replace Journal
merge m:1 ArticleID using `article', keep(master match) keepusing(_flesch_score _llm_readability_score _llm_g1_score _llm_g2_score _llm_g3_score _llm_g4_score _llm_g5_score) nogenerate
do `varlabels'
compress
tempfile duration
save `duration'
